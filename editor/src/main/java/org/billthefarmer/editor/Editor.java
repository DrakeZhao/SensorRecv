...
//        getActionBar().setSubtitle(match);
        ...
        try {
            ...
            Log.d("Tag", "onCreate: hey layout" + getResources().getResourceName(a));
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        invalidateOptionsMenu();
        Log.d(TAG, "onRestoreInstanceState1: " + path);
        file = new File(path);
        Log.d(TAG, "onRestoreInstanceState2: " + path + file);
...
//        sub.add(Menu.NONE, R.id.clearList, Menu.NONE, R.string.clearList);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (itemId == android.R.id.home) {
            ...
            saveAs();
        } else if (itemId == R.id.clearList) {
            clearList();
        } else if (itemId == R.id.findAll) {
            findAll();
        } else if (itemId == R.id.viewMarkdown) {
            viewMarkdown();
        } else if (itemId == R.id.viewFile) {
            viewFileClicked(item);
        } else if (itemId == R.id.autoSave) {
